...
package com.thanh_nguyen.youtubeapidemo;
...
import com.thanh_nguyen.youtube.R;
...
public class StandalonePlayerDemoActivity extends Activity implements View.OnClickListener {
  ...
  private static final String VIDEO_ID = "joE-ANMPG5k";
  private static final String PLAYLIST_ID =  "RDMMme0a3KSvEnI";
  private static final ArrayList<String> VIDEO_IDS = new ArrayList<String>(Arrays.asList(
      new String[] {"k_Sj4ON7iys", "srBO2D4-y1g"}));
